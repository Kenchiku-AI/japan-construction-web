...
interface CustomFieldDefinitionsListCellProps {
  item: CustomFieldDefinitionListItem;
  customObjects: CustomObjectDefinition[];
  onEdit: () => void;
  onDelete: () => void;
}

const CustomFieldDefinitionsListCell: FC<CustomFieldDefinitionsListCellProps> = ({
  item,
  customObjects,
  onEdit,
  onDelete
...
export default CustomFieldDefinitionsList;
