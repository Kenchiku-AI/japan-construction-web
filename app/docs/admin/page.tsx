    ...
    <div className="max-w-4xl space-y-12" style={{ color: "#7a7e82" }}>
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div>
              ...
              <p className="mt-1">
                日常的な運用業務を担います。ユーザーの招待、プロジェクト内の報告書の作成・編集、テンプレートの作成・編集、ゲストの管理が可能です。会社設定やプロジェクトのステータス変更はシステム管理者のみ実行できます。
              </p>
            </div>
      ...
      <section>
        ...
        <div className="space-y-4">
          <p>
            新しいユーザーを会社環境に招待できます。システム管理者と管理者が実行できます。
          </p>
      ...
      <section>
        ...
        <div className="space-y-4">
          <p>
            既存ユーザーの役割は、ユーザー詳細画面から変更できます。システム管理者はすべてのユーザーの権限を変更できます。管理者はシステム管理者以外のユーザーの権限を変更できます。
          </p>

          <p>権限を変更する手順は以下のとおりです。</p>

          <ol className="list-decimal pl-6 space-y-2">
            <li>会社画面のユーザー一覧から対象のユーザーを選択する</li>
            <li>権限のドロップダウンから新しい権限を選択する</li>
            <li>「ユーザーを更新」を選択する</li>
          </ol>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="space-y-4">
          <p>
            会社からユーザーを削除すると、そのユーザーはログインできなくなります。システム管理者と管理者が実行できます。ただし、管理者はシステム管理者を削除できません。
          </p>
      ...
      <section>
        ...
        <div className="space-y-4">
          <p>
            テンプレートの作成・編集はシステム管理者と管理者が行えます。ただし、Anthropicが提供するグローバルテンプレートはシステム管理者のみ編集できます。
          </p>

          <p>
            システム管理者は他の会社へテンプレートを共有する機能も利用できます。共有されたテンプレートは受け取った会社でも利用できます。
          </p>
      ...
      <section>
        ...
        <div className="space-y-4">
          <p>プロジェクトの作成とステータス変更はシステム管理者のみ実行できます。</p>

          <p>
            工事が完了したプロジェクトは「完了」ステータスに変更することを推奨します。完了済みのプロジェクトではユーザーとゲストが報告書を編集できなくなるため、記録の改ざんを防ぐことができます。
          </p>
      ...
      <section>
        ...
        <p>
          システム管理者は会社環境の基盤を整える役割を担います。テンプレートとタグを適切に設定しておくことで、現場担当者が一貫性のある報告書を効率よく作成できるようになります。ユーザーとプロジェクトの管理を適切に行い、必要な関係者だけが必要な情報にアクセスできる環境を維持してください。
        </p>
      </section>
    </div>
  );
